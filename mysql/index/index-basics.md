...
* [→ 각 scan 방식에 대한 실행 계획 (기본)](../labs/explain-table-access-types.md)
* [→ 각 scan 방식에 대한 실행 계획 (심화)](../labs/explain-advanced-index-scan.md)
...
# [→ OPTIMIZER](../optimization/optimizer-statistics.md)와 SCAN 방식
